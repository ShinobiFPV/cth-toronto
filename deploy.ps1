# Deploy Capture the Hood to shinobi (192.168.1.203).
#
...
$health = ssh $Target 'curl -sf --max-time 5 http://127.0.0.1:8093/api/health || echo FAILED'
...
Write-Host "Deployed Capture the Hood to shinobi" -ForegroundColor Green
Write-Host $health
